...
| 2026-07-23 | K3 verify ~18:04 | resolveCastBindings numeric PK enumeration | Intentional: MCP/agents bind with public id OR numeric row id (#576) |
| 2026-07-23 | K3 verify ~18:04 | presignR2Get signs arbitrary bucket keys | Host auth boundary; module workers are trusted internal callers |
| 2026-07-23 | K3 verify ~18:04 | stageAudioKeyForRenders copies out/ objects | Prefix guard + single-segment bind; host validates audioKey at route |
