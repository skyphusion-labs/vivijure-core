...
describe("finishOrderLegacyDialogue (A/B opt-in)", () => {
...
describe("resolveFinishChainForShot (A/B override)", () => {
  it("dialogue shot: #584 order by default", () => {
  ...
  it("non-dialogue shot: unchanged even with legacy flag", () => {
