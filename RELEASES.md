...
|---|---|---|---|---|
| `vivijure-core-v1.8.1` | 1.8.1 |  |  | **PATCH.** Post-1.8.0 main: PollResponse failure fields (#160), keyframe provenance `bundle_key` (#151 / cf#388), render `motion_backend`/`keyframe_backend` (#147 / cf#393; REQUIRES cf migration 0018 before host pin), scatter D1-empty dialogue fallback (#142 / core#122), docs audit (#158). Seeded by the version-bump PR; `source commit` and `published` stay EMPTY until tag + npm confirm. |
