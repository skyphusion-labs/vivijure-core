...
|---|---|---|---|---|
| `vivijure-core-v1.9.0` | 1.9.0 |  |  | **MINOR.** Homelab SDXL cast train via `LOCAL_BACKEND_URL` (`submitTrainLoraJob` / `pollCastLoraJob`); packages with cf#460 deterministic tar mtime. |
